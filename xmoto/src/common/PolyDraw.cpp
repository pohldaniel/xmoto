...
PolyDrawXM::PolyDrawXM(SDL_Surface *pBuf) {
  /* Set defaults */
  m_pLeftEdge = NULL;
  m_pRightEdge = NULL;
  m_pBuf = NULL;
...
PolyDrawXM::~PolyDrawXM() {
  /* Anything to be released? */
  _ReleaseEdgeBuffers();
}

void PolyDrawXM::setRenderBuffer(SDL_Surface *pBuf) {
...
TODO: assembler. :)  I simply don't think this code is fast enough to be of
      practical use.
=============================================================================*/
void PolyDrawXM::render(int *pnScreenVerts,
                      int *pnTexVerts,
                      int nNumCorners,
...
=============================================================================*/
void PolyDrawXM::_ReleaseEdgeBuffers(void) {
...
void PolyDrawXM::_LerpEdge(int y1,
                         int y2,
                         EdgeValue *pEdgeBuf,
                         int x1,
                         int x2,
...
void PolyDrawXM::_RenderHLine(int y,
                            EdgeValue *pLeft,
                            EdgeValue *pRight,
                            SDL_Surface *pTexture,
                            int nWSq,
