...
char *FileCompression::zcompress(const char *i_data,
                                 int i_len,
                                 int &o_outputLen) {
  ...
  nZRet = compress2((Bytef *)pcCompressedData,
                    &pcCompressedDataSize,
                    (Bytef *)i_data,
                    i_len,
                    9);
...
void FileCompression::zuncompress(const char *i_compressedData,
                                  int i_compressedLen,
                                  char *io_outputData,
                                  int i_outputDataLen) {
  int nZRet;
  ...
  nZRet = uncompress(
    (Bytef *)io_outputData, &v_len, (Bytef *)i_compressedData, i_compressedLen);
